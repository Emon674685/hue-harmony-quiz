...
Identify their skin tone and undertone. Then, using seasonal color analysis and color psychology, suggest the best color palette for them.
...
`;
    ...
    try {
      ...
      return parsed as { skinTone: "burns" | "tans" | "deep", undertone: "warm" | "cool" | "neutral", summary: string };
    } catch (error: any) {
